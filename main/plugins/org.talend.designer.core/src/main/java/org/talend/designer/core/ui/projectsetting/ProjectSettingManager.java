...
public class ProjectSettingManager extends Utils {
    ...
    private static void createExtraOnDBParameters(Element elem) {
        ...
        param.setRequired(true);
        param.setShowIf(dbCondition
                + " and (" + dbTypeName + " == 'OCLE' or " + dbTypeName + " == 'OCLE_OCI' or " + dbTypeName + " == 'POSTGRESQL' or "+ dbTypeName + " == 'SYBASE' or "+dbTypeName + " =='ACCESS' or " + dbTypeName + " =='MSSQL' or " + dbTypeName + " =='MYSQL')"); //$NON-NLS-1$ //$NON-NLS-2$//$NON-NLS-3$ //$NON-NLS-4$
        param.setGroup(IMPLICIT_GROUP);
        paramList.add(param);
