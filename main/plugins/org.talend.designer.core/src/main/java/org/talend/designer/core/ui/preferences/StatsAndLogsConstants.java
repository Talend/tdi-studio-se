...
public class StatsAndLogsConstants {
    ...
    public static final String[] ORACLE_VERSION_DISPLAY = new String[] {
    		"Oracle 19", "Oracle 18", "Oracle 12", "Oracle 11", "Oracle 10", "Oracle 9", "Oracle 8" }; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$

    public static final String[] ORACLE_VERSION_CODE = new String[] {
    		 "ORACLE_19", "ORACLE_18", "ORACLE_12", "ORACLE_11", "ORACLE_10", "ORACLE_9", "ORACLE_8" }; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$

    public static final String[] ORACLE_VERSION_DRIVER = new String[] {
            "ojdbc8-19.3.0.0.jar", "ojdbc8-12.2.0.1.jar", "ojdbc7.jar", "ojdbc6.jar", "ojdbc14.jar", "ojdbc14-9i.jar", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    public static final String[] DB_VERSION_DISPLAY = new String[] {"Oracle 19", "Oracle 18", "Oracle 12", "Oracle 11", "Oracle 10", "Oracle 9",
    ...
    public static final String[] DB_VERSION_CODE = new String[] {"ORACLE_19", "ORACLE_18", "ORACLE_12", "ORACLE_11", "ORACLE_10", "ORACLE_9", "ORACLE_8",
    ...
    public static final String[] DB_VERSION_DRIVER = new String[] {"ORACLE_19", "ORACLE_18", "ORACLE_12", "ORACLE_11", "ORACLE_10", "ORACLE_9",
