...
public class StatsAndLogsConstants {
    ...
    public static final String[] ORACLE_VERSION_DISPLAY = new String[] {
    		"Oracle 18c", "Oracle 12", "Oracle 11", "Oracle 10", "Oracle 9", "Oracle 8" }; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$

    public static final String[] ORACLE_VERSION_CODE = new String[] {
    		 "ORACLE_18C", "ORACLE_12", "ORACLE_11", "ORACLE_10", "ORACLE_9", "ORACLE_8" }; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    ...
    public static final String[] DB_VERSION_DISPLAY = new String[] {"Oracle 18c", "Oracle 12", "Oracle 11", "Oracle 10", "Oracle 9",
            "Oracle 8", "MySQL 5", "MySQL 4", "MariaDB","Open source JTDS", "Microsoft", "Access 2003", "Access 2007", "Prior to v9", "v9 +" };

    public static final String[] DB_VERSION_CODE = new String[] { "ORACLE_18C", "ORACLE_12", "ORACLE_11", "ORACLE_10", "ORACLE_9", "ORACLE_8",
            "MYSQL_5", "MYSQL_4", "MariaDB", "JTDS", "MSSQL_PROP","ACCESS_2003", "ACCESS_2007", "PRIOR_TO_V9", "V9_X" };

    public static final String[] DB_VERSION_DRIVER = new String[] { "ORACLE_18C","ORACLE_12", "ORACLE_11", "ORACLE_10", "ORACLE_9",
