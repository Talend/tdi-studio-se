...
public class StatsAndLogsConstants {
    ...
    public static final String[] AS400_VERSION_DISPLAY = new String[] { "V7R2 to V7R3", "V6R1 to V7R2", "V5R3 to V6R1", "V5R2 to V5R4" }; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$

    public static final String[] AS400_VERSION_CODE = new String[] { "AS400_V7R2_V7R3", "AS400_V6R1_V7R2", "AS400_V5R3_V6R1", "AS400_V5R2_V5R4" }; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ 
