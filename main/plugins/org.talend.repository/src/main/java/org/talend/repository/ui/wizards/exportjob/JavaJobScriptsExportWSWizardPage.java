...
public class JavaJobScriptsExportWSWizardPage extends JavaJobScriptsExportWizardPage {
    ...
    public static enum JobExportType {
        ...
        WSWAR(Messages.getString("JavaJobScriptsExportWSWizardPage.WSWAR1"), false), //$NON-NLS-1$
        WSZIP(Messages.getString("JavaJobScriptsExportWSWizardPage.WSZIP1"), false), //$NON-NLS-1$
