...
public class CSVReaderSav {
    ...
    public CSVReaderSav(String filename, char separator, String charset) throws IOException {
        this(new FileInputStream(filename), separator, charset);
    }

    public CSVReaderSav(InputStream inputStream, char separator, String charset) throws IOException {
        this(new UnicodeReader(inputStream, charset), separator);
    }

    public CSVReaderSav(Reader reader, char separator) {
        this.reader = new BufferedReader(reader,BUFFER_SIZE);
        this.separator = separator;
    }
    
    public static CSVReaderSav parse(String content) {
        if (content == null) {
            throw new IllegalArgumentException(
                    "Parameter content can not be null.");
        }

        return new CSVReaderSav(new StringReader(content),',');
    }
    
    public CSVReaderSav setLineEnd(String lineEnd) {
        this.lineEnd = lineEnd;
        return this;
    }

    public CSVReaderSav setSeparator(char separator) {
        this.separator = separator;
        return this;
    }

    public CSVReaderSav setEscapeChar(char escapechar) {
        this.escapechar = escapechar;
        return this;
    }
    
    public CSVReaderSav setQuoteChar(char quotechar) {
    ...
    public CSVReaderSav setTrimWhitespace(boolean trimWhitespace) {
        this.trimWhitespace = trimWhitespace;
        return this;
    }
    
    public CSVReaderSav setSkipEmptyRecords(boolean skipEmptyRecords) {
        this.skipEmptyRecords = skipEmptyRecords;
        return this;
    }
    
    public CSVReaderSav setStoreRawRecord(boolean storeRawRecord) {
