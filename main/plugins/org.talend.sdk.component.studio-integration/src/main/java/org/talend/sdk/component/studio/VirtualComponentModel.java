...
public class VirtualComponentModel extends ComponentModel {
    ...
    public String getName() {
        if (isMadeByTalend()) {
            if (isNetSuiteComponent(index)) {
                return "t" + TaCoKitUtil.getFullComponentName(getProcessedNetSuiteFamilyName(index), modelType.getDisplayName());
            }
    ...
    public static String getDefaultConnectionName(ComponentIndex index) {
        if (TaCoKitUtil.isTaCoKitComponentMadeByTalend(index)) {
            if (isNetSuiteComponent(index)) {
                return "t" + TaCoKitUtil.getFullComponentName(getProcessedNetSuiteFamilyName(index),
                        VirtualComponentModelType.CONNECTION.getDisplayName());
            }
            return "t" + TaCoKitUtil.getFullComponentName(index.getId().getFamily(),
                    VirtualComponentModelType.CONNECTION.getDisplayName());
        }
